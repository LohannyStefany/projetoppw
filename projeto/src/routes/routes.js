...
router.get('/conta-corrente', autenticacaoController.verificarAutenticacao, contaCorrenteController.getAll);
router.get('/conta-corrente/:id', autenticacaoController.verificarAutenticacao, contaCorrenteController.getById);
router.post('/conta-corrente', autenticacaoController.verificarAutenticacao, contaCorrenteController.create);
router.put('/conta-corrente/:id', autenticacaoController.verificarAutenticacao, contaCorrenteController.update);
router.delete('/conta-corrente/:id', autenticacaoController.verificarAutenticacao, contaCorrenteController.delete);
